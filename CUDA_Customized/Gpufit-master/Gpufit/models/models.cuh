    ...
    int const user_info_size)
{
    ...
    case SPLINE_3D_PHASE_MULTICHANNEL:
        ...
        break;
    case TTCM:
        calculate_TTCM(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    case EXP:
        calculate_EXP(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    default:
...
void configure_model(ModelID const model_id, int & n_parameters, int & n_dimensions)
{
    ...
    case TTCM:                  n_parameters = 4; n_dimensions = 1; break;
    case EXP:                  n_parameters = 3; n_dimensions = 1; break;
