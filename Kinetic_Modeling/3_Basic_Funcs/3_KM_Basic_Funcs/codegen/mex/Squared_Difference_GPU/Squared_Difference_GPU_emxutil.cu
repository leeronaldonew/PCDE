...
//
// Squared_Difference_GPU_emxutil.cu
//
...
void emxEnsureCapacity_real16_T(emxArray_real16_T *emxArray, int32_T oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtCallocMex(static_cast<uint32_T>(i), sizeof(real16_T));
...
{
  if (*pEmxArray != (emxArray_real16_T *)nullptr) {
    if (((*pEmxArray)->data != (real16_T *)nullptr) &&
    ...
    *pEmxArray = (emxArray_real16_T *)nullptr;
  }
}
...
void emxFree_real_T(emxArray_real_T **pEmxArray)
{
  if (*pEmxArray != (emxArray_real_T *)nullptr) {
    if (((*pEmxArray)->data != (real_T *)nullptr) &&
        (*pEmxArray)->canFreeData) {
      emlrtFreeMex((*pEmxArray)->data);
    }
    emlrtFreeMex((*pEmxArray)->size);
  ...
  *pEmxArray =
  ...
  if (doPush) {
    emlrtPushHeapReferenceStackEmxArray(
        emlrtRootTLSGlobal, false, (void *)pEmxArray, (void *)&emxFree_real16_T,
        nullptr, nullptr, nullptr);
  }
  emxArray = *pEmxArray;
  emxArray->data = (real16_T *)nullptr;
...
// End of code generation (Squared_Difference_GPU_emxutil.cu)
