function [Val_10,Ind_10]=Rank_AUC_Speedy_Slice(k,Num_Vox_row,Fitted_4D,permutes,PI_Time_fine,Time_intv,Ind_300,Local_Estimates)
...
for r=1:1:size(Fitted_4D,2)  
    [Row_FTACs]=Gen_Row_FTACs(r,Fitted_4D_Slice,PI_Time_fine);
    if Row_FTACs ==0
        ...
        [V,I]=Rank_AUC_Speedy(Row_DB_300,Row_FTACs,Time_intv);
    end
    if r==1
        Ind_10=I;
        Val_10=V;
